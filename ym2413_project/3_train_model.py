...
model = Sequential([
    ...
    Dropout(0.4),
    LSTM(32, return_sequences=False), # Output Layer return_sequences set to False
    Dropout(0.4),
...
model.fit(X_train, y_train, epochs=40, batch_size=128, validation_data=(X_val, y_val), callbacks=[checkpoint, early_stopping])
