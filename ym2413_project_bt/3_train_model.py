...
checkpoint = ModelCheckpoint(
    'model_best.keras',  # Path where the model should be saved
...
model.fit(X_train, y_train, epochs=100, batch_size=128, validation_data=(X_val, y_val), callbacks=[checkpoint, early_stopping, lr_scheduler])
