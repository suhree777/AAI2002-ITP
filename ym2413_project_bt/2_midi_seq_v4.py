...
def extract_midi_features(midi_file, target_rate=20):
    # Load MIDI file
    ...
    for instrument in midi_data.instruments:
        if not instrument.is_drum:  # Ignore drum instruments
            ...
            # Combine features into a single array for the instrument
        ...
        if os.path.isdir(mood_path):
            ...
            for midi_file in os.listdir(mood_path):
                if midi_file.endswith('.mid'):
                    ...
                    instrument_features = extract_midi_features(midi_path, target_rate)
